...
def data(api_client):
    ...
    return (
        {
            "list": reverse("UserLike-list"),
            "retrieve": reverse("UserLike-detail", kwargs={"pk": instance.pk}),
            "retrieve-not-found": reverse("UserLike-detail", kwargs={"pk": 1000}),
        },
        client,
        instance,
    )
